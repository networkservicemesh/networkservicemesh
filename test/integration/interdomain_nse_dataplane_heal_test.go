...
func TestInterdomainNSCAndICMPDataplaneHealLocal(t *testing.T) {
	...
	testInterdomainDataplaneHeal(t, 2,false, 0)
}
...
func TestInterdomainNSCAndICMPDataplaneHealRemote(t *testing.T) {
	...
	testInterdomainDataplaneHeal(t, 2,false, 1)
}

type HealFunc func(*testing.T, []*kubetest.ExtK8s, int, *v1.Pod)

/**
If passed 1 both will be on same node, if not on different.
*/
func testInterdomainDataplaneHeal(t *testing.T, clustersCount int, disableVHost bool, killIndex int) {
