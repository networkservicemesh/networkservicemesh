	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.NetworkservicemeshV1().NetworkServiceEndpoints(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NetworkservicemeshV1().NetworkServiceEndpoints(namespace).Watch(options)
			},
		},
		&networkservicev1.NetworkServiceEndpoint{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *networkServiceEndpointInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&networkservicev1.NetworkServiceEndpoint{}, f.defaultInformer)
}
