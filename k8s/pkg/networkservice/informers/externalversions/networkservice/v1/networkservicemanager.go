...
type NetworkServiceManagerInformer interface {
	...
	Lister() v1.NetworkServiceManagerLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.NetworkservicemeshV1().NetworkServiceManagers(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NetworkservicemeshV1().NetworkServiceManagers(namespace).Watch(options)
			},
		},
		&networkservicev1.NetworkServiceManager{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *networkServiceManagerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&networkservicev1.NetworkServiceManager{}, f.defaultInformer)
}

func (f *networkServiceManagerInformer) Lister() v1.NetworkServiceManagerLister {
	return v1.NewNetworkServiceManagerLister(f.Informer().GetIndexer())
}
