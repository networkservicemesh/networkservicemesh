...
func (c *FakeNetworkServices) Get(name string, options v1.GetOptions) (result *networkservicev1.NetworkService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(networkservicesResource, c.ns, name), &networkservicev1.NetworkService{})

	if obj == nil {
		return nil, err
	}
	return obj.(*networkservicev1.NetworkService), err
}

// List takes label and field selectors, and returns the list of NetworkServices that match those selectors.
func (c *FakeNetworkServices) List(opts v1.ListOptions) (result *networkservicev1.NetworkServiceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(networkservicesResource, networkservicesKind, c.ns, opts), &networkservicev1.NetworkServiceList{})
	...
	list := &networkservicev1.NetworkServiceList{ListMeta: obj.(*networkservicev1.NetworkServiceList).ListMeta}
	for _, item := range obj.(*networkservicev1.NetworkServiceList).Items {
...
func (c *FakeNetworkServices) Create(networkService *networkservicev1.NetworkService) (result *networkservicev1.NetworkService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(networkservicesResource, c.ns, networkService), &networkservicev1.NetworkService{})
...
func (c *FakeNetworkServices) Update(networkService *networkservicev1.NetworkService) (result *networkservicev1.NetworkService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(networkservicesResource, c.ns, networkService), &networkservicev1.NetworkService{})
...
func (c *FakeNetworkServices) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(networkservicesResource, c.ns, name), &networkservicev1.NetworkService{})
...
func (c *FakeNetworkServices) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &networkservicev1.NetworkServiceList{})
	return err
}

// Patch applies the patch and returns the patched networkService.
func (c *FakeNetworkServices) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *networkservicev1.NetworkService, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(networkservicesResource, c.ns, name, pt, data, subresources...), &networkservicev1.NetworkService{})
