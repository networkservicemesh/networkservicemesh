...
docker-build: docker-build-netmesh-test docker-build-netmesh docker-build-nsm-init docker-build-nse docker-build-nsc-memif docker-build-test-dataplane docker-build-sidecar-injector

# Individual targets are found in .nsm.mk
docker-push: docker-login docker-push-netmesh docker-push-test-dataplane docker-push-nsm-init docker-push-nse docker-push-nsc-memif docker-push-sidecar-injector
