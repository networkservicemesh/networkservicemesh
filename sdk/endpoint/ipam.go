...
func (ice *IpamEndpoint) Request(ctx context.Context, request *networkservice.NetworkServiceRequest) (*connection.Connection, error) {
	...
	srcIP, dstIP, prefixes, err := ice.PrefixPool.Extract(request.Connection.Id, currentIPFamily, request.Connection.Context.IpContext.ExtraPrefixRequest...)
	if err != nil {
		return nil, err
	}
	...
	newConnection.Context.IpContext.DstIpAddr = dstIP.String()
