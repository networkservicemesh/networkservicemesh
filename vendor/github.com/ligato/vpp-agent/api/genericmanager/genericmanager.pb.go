...
func (*GetConfigResponse_ConfigItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_436b82698a12e5e3, []int{12, 0}
}
...
func (m *GetConfigResponse_ConfigItem) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetConfigResponse_ConfigItem.Merge(m, src)
}
...
func (*DumpStateResponse_StateItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_436b82698a12e5e3, []int{14, 0}
}
...
func (m *DumpStateResponse_StateItem) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DumpStateResponse_StateItem.Merge(m, src)
}
