...
func (*ARPEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_008890a7d341a7be, []int{0}
}
...
func init() { proto.RegisterFile("models/linux/l3/arp.proto", fileDescriptor_008890a7d341a7be) }

var fileDescriptor_008890a7d341a7be = []byte{
