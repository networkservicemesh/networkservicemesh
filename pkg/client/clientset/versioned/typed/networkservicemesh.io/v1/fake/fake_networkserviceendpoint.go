...
var networkserviceendpointsResource = schema.GroupVersionResource{Group: "networkservice.mesh", Version: "v1", Resource: "networkserviceendpoints"}
...
func (c *FakeNetworkServiceEndpoints) Get(name string, options v1.GetOptions) (result *networkservicemeshiov1.NetworkServiceEndpoint, err error) {
	obj, err := c.Fake.
...
func (c *FakeNetworkServiceEndpoints) List(opts v1.ListOptions) (result *networkservicemeshiov1.NetworkServiceEndpointList, err error) {
	obj, err := c.Fake.
...
func (c *FakeNetworkServiceEndpoints) Create(networkServiceEndpoint *networkservicemeshiov1.NetworkServiceEndpoint) (result *networkservicemeshiov1.NetworkServiceEndpoint, err error) {
	obj, err := c.Fake.
...
func (c *FakeNetworkServiceEndpoints) Update(networkServiceEndpoint *networkservicemeshiov1.NetworkServiceEndpoint) (result *networkservicemeshiov1.NetworkServiceEndpoint, err error) {
	obj, err := c.Fake.
...
func (c *FakeNetworkServiceEndpoints) UpdateStatus(networkServiceEndpoint *networkservicemeshiov1.NetworkServiceEndpoint) (*networkservicemeshiov1.NetworkServiceEndpoint, error) {
	obj, err := c.Fake.
...
func (c *FakeNetworkServiceEndpoints) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *networkservicemeshiov1.NetworkServiceEndpoint, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(networkserviceendpointsResource, c.ns, name, data, subresources...), &networkservicemeshiov1.NetworkServiceEndpoint{})
