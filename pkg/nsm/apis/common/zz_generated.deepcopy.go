...
func (in *LocalMechanism) DeepCopyInto(out *LocalMechanism) {
	*out = *in
	if in.Parmeters != nil {
		...
		*out = new(LocalMechanismParameters)
		(*in).DeepCopyInto(*out)
	}
	out.XXX_NoUnkeyedLiteral = in.XXX_NoUnkeyedLiteral
	if in.XXX_unrecognized != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LocalMechanismParameters) DeepCopyInto(out *LocalMechanismParameters) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LocalMechanismParameters.
func (in *LocalMechanismParameters) DeepCopy() *LocalMechanismParameters {
	if in == nil {
		return nil
	}
	out := new(LocalMechanismParameters)
