...
func (in *ConnectionContext) DeepCopyInto(out *ConnectionContext) {
	*out = *in
	if in.ConnectionContext != nil {
		in, out := &in.ConnectionContext, &out.ConnectionContext
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConnectionContext.
func (in *ConnectionContext) DeepCopy() *ConnectionContext {
	if in == nil {
		return nil
	}
	out := new(ConnectionContext)
	in.DeepCopyInto(out)
	return out
}
