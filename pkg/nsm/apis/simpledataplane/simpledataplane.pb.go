...
func (NSMPodType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_simpledataplane_cd00b8d0fb99e4fb, []int{0}
}
...
func (*BuildConnectRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_simpledataplane_cd00b8d0fb99e4fb, []int{1}
}
...
func (*BuildConnectReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_simpledataplane_cd00b8d0fb99e4fb, []int{2}
}
...
func (*DeleteConnectRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_simpledataplane_cd00b8d0fb99e4fb, []int{3}
}
...
func (*DeleteConnectReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_simpledataplane_cd00b8d0fb99e4fb, []int{4}
}
...
func (c *buildConnectClient) RequestDeleteConnect(ctx context.Context, in *DeleteConnectRequest, opts ...grpc.CallOption) (*DeleteConnectReply, error) {
	out := new(DeleteConnectReply)
	err := c.cc.Invoke(ctx, "/simpledataplane.BuildConnect/RequestDeleteConnect", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BuildConnect_RequestDeleteConnect_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteConnectRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BuildConnectServer).RequestDeleteConnect(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/simpledataplane.BuildConnect/RequestDeleteConnect",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BuildConnectServer).RequestDeleteConnect(ctx, req.(*DeleteConnectRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _BuildConnect_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _BuildConnect_RequestDeleteConnect_Handler,
		},
	},
...
func init() {
	proto.RegisterFile("simpledataplane.proto", fileDescriptor_simpledataplane_cd00b8d0fb99e4fb)
}

var fileDescriptor_simpledataplane_cd00b8d0fb99e4fb = []byte{
	// 452 bytes of a gzipped FileDescriptorProto
	,
}
