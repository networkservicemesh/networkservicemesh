...
func (CrossConnectEventType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_crossconnect_da1ac176d3002c6c, []int{0}
}

type CrossConnectState int32

const (
	CrossConnectState_SRC_DOWN CrossConnectState = 0
	CrossConnectState_DST_DOWN CrossConnectState = 1
)
...
func (CrossConnectState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_crossconnect_da1ac176d3002c6c, []int{1}
}
...
func (m *CrossConnect) GetState() CrossConnectState {
	...
	return CrossConnectState_SRC_DOWN
}
...
func init() { proto.RegisterFile("crossconnect.proto", fileDescriptor_crossconnect_da1ac176d3002c6c) }

var fileDescriptor_crossconnect_da1ac176d3002c6c = []byte{
	// 558 bytes of a gzipped FileDescriptorProto
	,
}
