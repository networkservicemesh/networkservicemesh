...
func (*NetworkServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_networkservice_5184545855ddacf7, []int{0}
}
...
func init() {
	proto.RegisterFile("networkservice.proto", fileDescriptor_networkservice_5184545855ddacf7)
}

var fileDescriptor_networkservice_5184545855ddacf7 = []byte{
