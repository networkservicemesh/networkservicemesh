...
func (MechanismType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_connection_18f949233df434c8, []int{0}
}
...
func (ConnectionEventType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_connection_18f949233df434c8, []int{1}
}
...
func (*ConnectionEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_connection_18f949233df434c8, []int{2}
}
...
func init() { proto.RegisterFile("connection.proto", fileDescriptor_connection_18f949233df434c8) }

var fileDescriptor_connection_18f949233df434c8 = []byte{
