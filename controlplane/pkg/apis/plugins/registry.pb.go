...
const (
	PluginFeature_CONNECTION PluginFeature = 0
)

var PluginFeature_name = map[int32]string{
	0: "CONNECTION",
}

var PluginFeature_value = map[string]int32{
	"CONNECTION": 0,
}

func (x PluginFeature) String() string {
	return proto.EnumName(PluginFeature_name, int32(x))
}

func (PluginFeature) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_41af05d40a615591, []int{0}
}

type PluginInfo struct {
	Endpoint             string          `protobuf:"bytes,1,opt,name=endpoint,proto3" json:"endpoint,omitempty"`
	Features             []PluginFeature `protobuf:"varint,2,rep,packed,name=features,proto3,enum=plugins.PluginFeature" json:"features,omitempty"`
...
func (m *PluginInfo) GetFeatures() []PluginFeature {
	if m != nil {
		return m.Features
	}
	return nil
...
func init() {
	proto.RegisterEnum("plugins.PluginFeature", PluginFeature_name, PluginFeature_value)
...
var fileDescriptor_41af05d40a615591 = []byte{
	...
	,
}
