...
type CrossConnect_LocalSource struct {
	LocalSource *connection2.Connection `protobuf:"bytes,4,opt,name=local_source,json=localSource,proto3,oneof"`
}

type CrossConnect_RemoteSource struct {
	RemoteSource *connection.Connection `protobuf:"bytes,5,opt,name=remote_source,json=remoteSource,proto3,oneof"`
}
...
func (m *CrossConnect) GetLocalSource() *connection2.Connection {
...
type CrossConnect_LocalDestination struct {
	LocalDestination *connection2.Connection `protobuf:"bytes,6,opt,name=local_destination,json=localDestination,proto3,oneof"`
}

type CrossConnect_RemoteDestination struct {
	RemoteDestination *connection.Connection `protobuf:"bytes,7,opt,name=remote_destination,json=remoteDestination,proto3,oneof"`
}
...
func (m *CrossConnect) GetLocalDestination() *connection2.Connection {
