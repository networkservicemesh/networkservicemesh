...
import fmt "fmt"
import math "math"
import connectioncontext "github.com/networkservicemesh/networkservicemesh/controlplane/api/connectioncontext"
...
func (State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_connection_522138baffe4f2ee, []int{0}
}
...
func (ConnectionEventType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_connection_522138baffe4f2ee, []int{1}
}
...
func (*ConnectionEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_connection_522138baffe4f2ee, []int{2}
}
...
func (*MonitorScopeSelector) Descriptor() ([]byte, []int) {
	return fileDescriptor_connection_522138baffe4f2ee, []int{3}
}
...
func init() { proto.RegisterFile("connection.proto", fileDescriptor_connection_522138baffe4f2ee) }

var fileDescriptor_connection_522138baffe4f2ee = []byte{
