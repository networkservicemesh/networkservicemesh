...
type ConnectionWrapper_RemoteConnection struct {
	RemoteConnection *connection2.Connection `protobuf:"bytes,2,opt,name=remote_connection,json=remoteConnection,proto3,oneof"`
}
...
func (m *ConnectionWrapper) GetRemoteConnection() *connection2.Connection {
