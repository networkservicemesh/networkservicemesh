...
import connection "github.com/networkservicemesh/networkservicemesh/controlplane/api/connection"
...
func (*NetworkServiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_networkservice_cd1e46aff185478e, []int{0}
}
...
func init() {
	proto.RegisterFile("networkservice.proto", fileDescriptor_networkservice_cd1e46aff185478e)
}

var fileDescriptor_networkservice_cd1e46aff185478e = []byte{
