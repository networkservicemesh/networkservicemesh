...
type NetworkService struct {
	...
	Channels             []*NetworkService_NetmeshChannel `protobuf:"bytes,4,rep,name=channels,proto3" json:"channels,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                         `json:"-"`
	XXX_unrecognized     []byte                           `json:"-"`
	XXX_sizecache        int32                            `json:"-"`
}
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "netmesh.NetworkService.SelectorEntry")
