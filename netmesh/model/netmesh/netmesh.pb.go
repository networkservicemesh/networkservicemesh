...
func (*NetworkServiceEndpoint) Descriptor() ([]byte, []int) { return fileDescriptorNetmesh, []int{0} }
...
func (*NetworkService) Descriptor() ([]byte, []int) { return fileDescriptorNetmesh, []int{1} }
...
func (*NetworkService_NetmeshChannel) Descriptor() ([]byte, []int) {
	return fileDescriptorNetmesh, []int{1, 0}
}
...
func init() { proto.RegisterFile("netmesh.proto", fileDescriptorNetmesh) }

var fileDescriptorNetmesh = []byte{
