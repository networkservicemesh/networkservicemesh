...
import (
	...
	"github.com/ligato/networkservicemesh/dataplanes/vpp-agent/pkg/nsmregistration"
...
func startDataplaneAgent(vpp *nsmvpp.VPPAgentClient, stopCh chan struct{}) error {
	wg.Add(1)
	defer wg.Done()
